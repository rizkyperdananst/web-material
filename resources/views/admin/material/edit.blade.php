@extends('admin')
@section('title', 'Admin | Edit Material')
    ...
    <div class="row mt-2 mb-2">
        <div class="col-md-12">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.material.update', $m->id) }}" method="POST">
                        @method('put')
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="stok" value="{{ $m->stok }}" id="stok"
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="harga" value="{{ $m->harga }}" id="harga"
